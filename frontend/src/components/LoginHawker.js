...
let navigate=useNavigate()
  ...
  const handleSubmit=async(e)=>{
    ...
    //  fetch("http://localhost:5000/api/auth/login")
     const response = await fetch("/api/auth/loginhawker", {
      method: 'POST',
      headers: {
  ...
  const onChange=(e)=>{
    ...
    return (
      ...
      <h1 style={{fontSize:"5rem",marginBottom:"2rem"}}> Hawker Login </h1>
